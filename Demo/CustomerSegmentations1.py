def segmentaions(val, components_con):
    ...
    GPForHigh = ((totalHighPrice - totalCost)/totalHighPrice) * 100  #GP = ((Total price - Total Cost)/Total Price) * 100
    GPForMedium = ((totalMediumPrice - totalCost)/totalMediumPrice) * 100
    GPForLow = ((totalLowPrice - totalCost)/totalLowPrice) * 100
