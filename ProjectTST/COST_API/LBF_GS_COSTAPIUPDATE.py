class CostAPI:
    ...
    def UOMQtyUpdate(self):
        for item in context.Quote.GetAllItems():
            ...
            if str(int(item.RolledUpQuoteItem)) == str(int(self.currentItemId)) and str(item['LBF_QU_TARUOM']) != str(unitOfMesasure):
            ...
            elif str(int(item.RolledUpQuoteItem)) == str(int(self.currentItemId)) and str(item['LBF_QU_TARUOM']) == str(unitOfMesasure):
