    ...
    for row in data:
        ...
        if len(res) != 0:
            ...
            if len(res) == 0:
                ...
                Trace.Write("Add " + str(upsertResult))
            else:
                for rec in res:
            ...
            Trace.Write("Product is not there in CPQ")


update_MaterialTable([{'DIV' : '20', 'Plant' : '2002', 'STD' : '14106.67', 'NET_WEIGHT' : '38.999', 'GROSS_WEIGHT' : '38.999', 'SORG' : '1000', 'PRICE_UNIT' : '1000', 'MAVP' : '14267.86', 'MATERIAL' : '801650', 'SAP_COST' : '14267.86', 'WEIGHT_UNIT' : 'LB', 'DC' : '10'}])
