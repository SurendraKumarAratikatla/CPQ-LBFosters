def segmentaions(val, components_con):
    ...
    Product.Attr('LBF_AR_RFS_TEMPLISTPRICE').AssignValue(str(price))
    Product.Attr('LBF_AR_RFS_TEMPCOST').AssignValue(str(cost))
...
custSegmentaion = Product.Attr('LBF_AR_RFSCS').SelectedValue
