class InforMat():
    ...
    def PriceCostUpdate(self):
        ...
        for item in context.Quote.GetAllItems():
            ...
            if inforData:
                Log.Info('LBF_QC_InforMatCheck ran')
                ...
                if site == "RMP":
                    ...
                    if inforData.UNIT_COST_USD and query_currencies:
                        item['LBF_QU_MAT_CST'] = str(float(inforData.UNIT_COST_USD)*float(query_currencies.QUOTE))
